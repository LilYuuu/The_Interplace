...
function updateTHREE() {
  ...
  // for (let i = 0; i < temp_particles.length; i++) {
  ...
  for (let i = 0; i < particles.length; i++) {
    ...
    clrArray[index + 0] = p.clr.r;
    clrArray[index + 1] = p.clr.g;
    clrArray[index + 2] = p.clr.b;
  }
...
function getPoints() {
  ...
  */
  for (let i = 0; i < particles.length; i++) {
    ...
    let index = i * 3;
    vertices[index + 0] = p.pos.x;
    vertices[index + 1] = p.pos.y;
    vertices[index + 2] = p.pos.z;
  }
