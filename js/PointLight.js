class PointLight {
  constructor(intensity) {
    ...
    this.mesh = getSphere();
    this.light = getPointLight(this.intensity);
  ...
  update() {
    this.viewY = lerp(this.viewY, this.pos.y, 0.05);
    this.group.position.set(this.pos.x, this.viewY, this.pos.z);
